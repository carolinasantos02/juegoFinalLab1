...
class FormMenuGameOver(Form):
    def __init__(self,name,master_surface,x,y,w,h,color_background,color_border,active):
        ...
        self.txt1 = TextBox(master=self,x=175,y=50,w=140,h=50,color_background=None,color_border=None,image_background="recursos\\txt lose.png",text="",font="Verdana",font_size=30,font_color=C_BLACK)
