...
class FormGameLevel2(Form):
    def __init__(self,name,master_surface,x,y,w,h,color_background,color_border,active):
        ...
        self.boton_pause = Button(master=self,x=400,y=10,w=100,h=30,color_background=None,color_border=None,image_background="recursos\\but pause.png",on_click=self.on_click_boton1,on_click_param="form_menu_B_2",text="",font="Verdana",font_size=30,font_color=C_WHITE)
        ...
        # --- GAME ELEMNTS --- 
        self.static_background = Background(x=0,y=0,width=w,height=h,path="recursos\\Assets\\locations\\set_bg_01\\city\\all.png")
        ...
        self.enemy_list = []
        self.enemy_list.append (Enemigo(350, 675, 0, 0, 2, 8, 25))

        self.frutas_list = []

        self.plataform_list = []
        self.plataform_list.append(Plataforma(50, 400, 80, 80, 1))

        self.frutas_list.append(Fruta(50, 375))
    ...
    def draw(self): 
        ...
        if len(self.frutas_list) == 0 and len(self.enemy_list) == 0:
            ...
            self.frutas_list.append(Fruta(50, 375))
            self.enemy_list.append (Enemigo(350, 675, 0, 0, 2, 8, 25))
            self.player_1 = Personaje(900, 600, 0, 0, 6, 8, 16, 25)
