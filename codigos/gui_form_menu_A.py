...
class FormMenuA(Form):
    def __init__(self,name,master_surface,x,y,w,h,color_background,color_border,active):
        ...
        self.boton1 = Button(master=self,x=20,y=50,w=140,h=50,color_background=None,color_border=None,image_background="recursos\\but nivel 1.png",on_click=self.on_click_boton3,on_click_param="form_game_L1",text="",font="Verdana",font_size=30,font_color=C_WHITE)
        self.boton2 = Button(master=self,x=20,y=150,w=140,h=50,color_background=None,color_border=None,image_background="recursos\\but nivel 2.png",on_click=self.on_click_boton3,on_click_param="form_game_L2",text="",font="Verdana",font_size=30,font_color=C_WHITE)
        self.boton3 = Button(master=self,x=20,y=250,w=140,h=50,color_background=None,color_border=None,image_background="recursos\\but nivel 3.png",on_click=self.on_click_boton3,on_click_param="form_game_L3",text="",font="Verdana",font_size=30,font_color=C_WHITE)
        self.boton4 = Button(master=self,x=300,y=150,w=140,h=50,color_background=None,color_border=None,image_background="recursos\\but exit.png",on_click=self.on_click_boton1,on_click_param="",text="",font="Verdana",font_size=30,font_color=C_WHITE)
        ...
        # self.txt1 = TextBox(master=self,x=200,y=50,w=240,h=50,color_background=None,color_border=None,image_background="recursos\\but exit.png",text="Text",font="Verdana",font_size=30,font_color=C_BLACK)
