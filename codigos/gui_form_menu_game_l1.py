...
# import json
# #C:\\Users\\Usuario\\Desktop\\CAROLINA\\PYL 1C 2023\\JUEGO\\codigos\\data_niveles.json

# with open('codigos\\data_niveles.json') as archivo:
#     data_niveles = json.load(archivo)

# data_nivel_1 = data_niveles["nivel_1"]
...
class FormGameLevel1(Form):
    def __init__(self,name,master_surface,x,y,w,h,color_background,color_border,active):
        ...
        self.boton_pause = Button(master=self,x=400,y=10,w=100,h=30,color_background=None,color_border=None,image_background="recursos\\but pause.png",on_click=self.on_click_boton1,on_click_param="form_menu_B_1",text="",font="Verdana",font_size=30,font_color=C_WHITE)
        ...
        # --- GAME ELEMNTS --- 
        self.static_background = Background(x=0,y=0,width=w,height=h,path="recursos\\Assets\\locations\\set_bg_01\\forest\\all.png")
        self.tiempo_actual = time.time()
        self.player_1 = Personaje(0, 600, 0, 0, 6, 8, 16, 25)
        self.barra_superior = Barra(self.player_1)
        self.enemy_list = []
        self.enemy_list.append (Enemigo(400, 450, 0, 0, 2, 8, 25))
        ...
        self.plataform_list = []
        # for item in data_nivel_1:
        #     if item in "plataformas":
        #         self.plataform_list.append(item)
        self.plataform_list.append(Plataforma(200, 500, 80, 80, 1))
        self.plataform_list.append(Plataforma(900, 500, 80, 80, 1))
        self.plataform_list.append(Plataforma(480, 500, 80, 80, 1))   
        self.plataform_list.append(Plataforma(480, 500, 80, 80, 1))

        self.frutas_list.append(Fruta(900, 475))
