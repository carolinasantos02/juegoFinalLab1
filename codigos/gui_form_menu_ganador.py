...
class FormMenuGanador(Form):
    def __init__(self,name,master_surface,x,y,w,h,color_background,color_border,active):
        ...
        self.boton2 = Button(master=self,x=175,y=150,w=140,h=50,color_background=None,color_border=None,image_background="recursos\\but menu.png",on_click=self.on_click_boton1,on_click_param="form_menu_A",text="",font="Verdana",font_size=30,font_color=C_WHITE)
        ...
        self.txt1 = TextBox(master=self,x=175,y=50,w=140,h=50,color_background=None,color_border=None,image_background="recursos\\txt win.png",text="",font="Verdana",font_size=30,font_color=C_BLACK)
        ...
        self.lista_widget = [self.boton1, self.boton2, self.txt1]
